<?php
    ...
    if(isset($_POST['login_btn']))
    {
        ...
        if(!isset($loginErr))
        {
            $c_login = "select * from client_profile where email like '$user_email' and password like '$user_password'";
            ...
            {
                if(mysqli_num_rows($run_c_login) > 0)
                {
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                        ...
                                        <table id="login-form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="user_email" name="user_email" class="input-text" placeholder="enter your email" value="<?php echo $user_email; ?>" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <div id="customer_details" class="col2-set">
                                    <div class="">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <table cellspacing="30" id="reg-form">
                                                <tr align="center">
                                                    <td colspan="2">
