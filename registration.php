<?php
    ...
    $name = $email = $phone = $location = $p_desc = $u_email = $u_pswd = "";
    ...
    if(isset($_POST['register']))
    {
        ...
        if(!isset($error))
        {
                ...
                $insert = "insert into client_profile (bus_name, email, cell_phone, bus_age, location, bus_desc, password, verified)
                                                values('$name','$email','$phone','$age','$location','$p_desc','$pass','NO')";
    ...
    if(isset($_POST['login']))
    {
        ...
        if(!isset($loginErr))
        {
            $c_login = "select * from client_profile where email like '$u_email' and password like '$u_pswd'";
            $run_c_login = mysqli_query($con, $c_login);
            if (!$run_c_login)
            {
                echo "Error: " . $c_login . $con ->error;
                $loginErr = " Error Logging into Account";
                exit("Error Logging into Account");
            }
            else
            {
                if(mysqli_num_rows($run_c_login) == 1)
                {
...
<html lang="en">
  <head>
    ...
    <title>CHIROWA | MERCHANT REGISTRATION</title>
...
<div class="mainmenu-area">
    ...
    <div class="product-big-title-area" style="background:#FBFBFB;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2 style="color:#18AAE7;">
                            Want to Sell on Chirowa?
                        </h2>
                        ...
                        <div class="woocommerce">
                            ...
                            <div id="message">
                                ...
                                <div id="user_login">
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                        <p class="login_header">Enter Login Details Below</p><br/>
                                        <table id="login-form">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <div id="login_msg">
                                                                    ...
                                                                    <?php
                                                                        echo "Login Unsuccessful: " . $loginErr;
                                                                    ?>
                                                                </div><br>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td><label for="user_email">Email <span class="required">*</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <input type="text" id="user_email" name="user_email" class="input-text" placeholder="enter your email" value="<?php echo $u_email; ?>" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="password" id="password" name="user_password" class="input-text" placeholder="enter your password" value="<?php echo $u_pswd; ?>" required>
                                                    <div class="clear"></div>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="woocommerce-info">Dont have an Account? 
                            ...
                            <script>
                                ...
                                {    
                                    ...
                                    {
                                        $("#reg-form-wrap").collapse('toggle');
                                        $("#reg-form-wrap")[0].scrollIntoView(
                                        {
                                            behavior: "smooth", // or "auto" or "instant"
                                            block: "start" // or "end"
                                        });
                            ...
                            <form method="post" class="collapse" id="reg-form-wrap" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">

                                <div id="customer_details" class="col2-set">
                                    <div class="">
                                        <div class="woocommerce-billing-fields">

                                            <table cellspacing="30" style="width:50%; margin:0 auto;">
                                                <tr align="center">
                                                    <td colspan="2">
                                                        <p id="reg_header">Fill Out the Registration Form Below</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="30%">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="" for="company_phone">Phone Number &nbsp;
                                                        </label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input list="numbers" type="text" value="<?php echo $bus_age; ?>" placeholder="years in business" id="company_age" name="bus_age" class="input-text" required>
                                                        <datalist id="numbers">
                                                          <option value="1">
                                                          <option value="2">
                                                          <option value="3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="" for="company_location">
                                                            Business Location 
                                                            &nbsp;
                                                        </label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" name="pro_desc" class="input-text" placeholder="Describe your products/services" id="pro_desc"  onfocus="hideDescError(this.id);" value="<?php echo $p_desc; ?>" required>
                                                        <div class="clear"></div>
                                                ...
                                                <tr>
                                                    <td colspan="2" align="right">
                                                        <input type="submit" class="manu" data-value="Submit" value="Register" name="register" id = "submit_btn">
                                                        <div class="clear"></div>
                                                    </td>
                                                </tr>
                                            </table>
