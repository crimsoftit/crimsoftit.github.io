...
$(document).ready(function(){
        $("#reg-form-wrap").collapse('show');
                                ...
                                <form id="user_login" method="post" action="">
                                    <p class="login_header">Enter Login Details Below</p>
                                    <table id="login-form">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="user_email" name="user_email" class="input-text" placeholder="enter your email" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input type="password" id="password" name="password" class="input-text" placeholder="enter your password" required>
                                                <div class="clear"></div>
                                            </td>
                                        </tr>
                                        <tr>
							...
							<div class="woocommerce-info">Dont have an Account? <button class="showlogin" href="" >Click here to sign up</button> 
                            </div>
                                    ...
                                    <div class="">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <table id="reg-form">
                                                <tr>
                                                    <td>
                                                        <label class="" for="company_name">
                                                            Merchant Name <abbr title="required" class="required">*</abbr>
                                                        </label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <p class="login_header" style="font-size:16px; background: white;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="" for="account_password">
                                                            Confirm password <abbr title="required" class="required">*</abbr>
                                                        </label>
                                                    </td>
                                                    <td>
