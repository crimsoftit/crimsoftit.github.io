...
<html lang="en">
  <head>
    ...
    <title>CHIROWA | EDIT PROFILE</title>
                                    ...
                                    <div class="">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <table cellspacing="30" style="width:50%; margin:0 auto;">
                                                <tr align="center">
                                                    <td colspan="2">
                                                        <p id="reg_header" style="width:100%; background:white; margin-top:10px; border-radius:10px;">
                                                            Edit Account Details<br>
                                                            <img src="<?php echo $business_logo; ?>"> 
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" value="<?php echo $business_name; ?>" placeholder="Company/Business Name" id="company_name" name="company" class="c_name" onfocus="hideNameError(this.id);" required />
                                                        <div class="clear"></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" value="<?php echo $business_email; ?>" placeholder="Email Address" id="company_email" name="email" class="input-text" onfocus="hideEmailError(this.id);" required />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" value="<?php echo $cell_phone; ?>" placeholder="eg. 0700000000" id="company_phone" name="phone" class="input-text"  onfocus="hidePhoneError(this.id);" required>
