                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                if(data == 'No')
                                {
                                    $('#msg').show();
                                    $('#msg').css("color", "red");
                                    $('#msg').html("<i class='fa fa-exclamation-circle'></i> Email or password mismatch");
                                }
                                else if(data == 'Yes')
                                {
                                    $('#msg').show();
                                    $('#msg').css("color", "green");
                                    $('#msg').html("<i class='fa fa-check-circle'></i> Login successful");
                        ...
                        <ul>
                            ...
                            <li>
                                <?php 
                                    ...
                                    {
                                        ?>
                                            <a href="#" id="login" data-target="#loginModal" data-toggle="modal"><i class="fa fa-user"></i> Login</a>
                                        <?php
                                    }
                                    else
                                    {
